...
describe('XSLT codegen apply-templates relative-select emission', () => {
  it('emits native code for a root apply-templates with a simple relative select', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FIXTURE_STYLESHEET, 'apply-templates-relative.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each with xsl:choose', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_CHOOSE_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-choose.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each with xsl:choose without xsl:otherwise', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_CHOOSE_NO_OTHERWISE_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-choose-no-otherwise.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each with multiple xsl:when branches', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_CHOOSE_MULTI_WHEN_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-choose-multi-when.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each with nested xsl:if bodies inside xsl:choose branches', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_CHOOSE_NESTED_IF_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-choose-nested-if.xsl');
  ...
  it('emits native code for a root apply-templates with a relative select and a child template containing xsl:for-each with nested xsl:choose blocks inside xsl:choose branches', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_CHOOSE_NESTED_CHOOSE_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-choose-nested-choose.xsl');
  ...
  it('emits native code when a root apply-templates with a relative select uses a child template containing xsl:for-each with nested xsl:apply-templates', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_APPLY_TEMPLATES_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-apply-templates.xsl');
  ...
  it('emits native code when a root apply-templates with a relative select uses a child template containing xsl:for-each with nested xsl:apply-templates without select', () => {
    const { emitted, transpiled } = transpileEmittedModule(APPLY_TEMPLATES_RELATIVE_SELECT_FOR_EACH_APPLY_TEMPLATES_DEFAULT_FIXTURE_STYLESHEET, 'apply-templates-relative-for-each-apply-templates-default.xsl');
