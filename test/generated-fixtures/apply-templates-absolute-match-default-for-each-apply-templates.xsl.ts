...
export function transform(sourceXml: string, ctx: TransformContext = {}): TransformResult {
  ...
  "<detail>" +
    escapeText(traceStringValueOfNode(templateNode, ctx, {"kind":"xsl:value-of","location":{"source":"apply-templates-absolute-match-default-for-each-apply-templates.xsl","line":1,"column":217,"offset":216,"endLine":1,"endColumn":221,"endOffset":220}})) +
    "</detail>"
);
})()
)).join("")
